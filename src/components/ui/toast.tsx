...
function Toasts({
  ...
  return (
    <Toast.Portal data-slot="toast-portal" {...portalProps}>
      <Toast.Viewport
        className={cn(
          "fixed z-60 mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-80 [--toast-inset:--spacing(4)] sm:[--toast-inset:--spacing(8)]",
        ...
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Root
              ...
              toast={toast}
            >
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-3 overflow-hidden px-3.5 py-2.5 text-[14px] leading-5 transition-opacity duration-250 data-behind:opacity-0 data-behind:not-data-expanded:pointer-events-none data-expanded:opacity-100">
                <div className="flex min-w-0 gap-2">
                  {Icon && (
                    <div
                      className="flex h-5 shrink-0 items-center [&_svg]:pointer-events-none [&>svg]:size-[16px]"
              ...
              >
                {tooltipStyle ? (
                  <Toast.Content className="pointer-events-auto px-2 py-1">
                    <Toast.Title
                      className="leading-inherit font-medium text-inherit"
                      data-slot="toast-title"
                    />
                  </Toast.Content>
                ) : (
